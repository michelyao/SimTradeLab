...
class XiaoshizhiStrategy:
    ...
    def initialize(self, context):
        """初始化策略"""
        log.info("line:{} [xiaoshizhi strategy initialized]".format(30))
        self.selected_stocks = []
        self.signals = []
    ...
    def check_signals(self, context):
        ...
        stoploss_signals = check_stoploss_sell_signal(context, context.portfolio.positions)
        ...
        for signal in self.signals:
            ...
            try:
                ...
                if position.closeable_amount > 0:
                    ...
                    log.info("line:{} [execute sell] stock: {} signal_type: {} price: {}".format(
                        62, stock, signal['signal_type'], signal['price']))
            except Exception as e:
                log.error("line:{} [execute sell error] stock: {} error: {}".format(65, stock, e))
...
def initialize(context):
    ...
    run_daily(context, before_trading_start, time='09:30')
    run_daily(context, check_signals_and_execute, time='10:00')
    run_daily(context, check_signals_and_execute, time='14:00')
...
def check_signals_and_execute(context):
    """检查信号并执行"""
